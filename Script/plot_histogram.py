...
parser.add_argument("--index", help="Index Results JSON", type=int)
...
plt.legend(frameon=True, facecolor='white', bbox_to_anchor=(0.5, 1.15), loc='upper center', borderaxespad=0., prop={'size':6})
